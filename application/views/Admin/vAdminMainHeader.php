    ...
    <ul class="navbar-nav bg-gradient-dark sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <hr class="sidebar-divider">
        ...
        <li class="nav-item <?php if ($category === "Daftar Ibadah") {
          ...
          <a class="nav-link" href="<?= base_url('Admin/daftarIbadah');?>">
        ...
        <li class="nav-item <?php if ($category === "Tambah Ibadah") {
          ...
          <a class="nav-link" href="<?= base_url('Admin/tambahIbadah');?>">
            <i class="fas fa-fw fa-plus"></i>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              ...
              <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                <a class="dropdown-item <?php if($this->session->userdata('role')!=="admin"){ echo "d-none"; }?>" href="<?= base_url('Dashboard')?>">
