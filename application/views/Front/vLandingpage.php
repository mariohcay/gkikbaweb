        ...
        <div class="container px-4 px-lg-5">
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-8 text-center">
                    ...
                    Sehubungan dengan penurunan level PPKM maka ibadah <b class="text-white"><i>onsite-online (hybrid)</i></b> dengan perwakilan jemaat direncanakan mulai <b class="text-white">31 Oktober 2021</b>. <br><b class="text-white">Syarat: Prokes, sudah mendapatkan vaksin, berusia 13 – 70 tahun.</b> <br><br>Minggu ke-1 dan ke-2 kehadiran jemaat per lingkungan. Minggu ke-3 dan ke-4 undangan umum dengan pendaftaran maksimal hari Kamis. Penatua pendamping berkoordinasi dengan koordinator lingkungan.
                    </p>
                    <a class="btn btn-light btn-xl scroll" href="#ibadah">Dapatkan Link</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                ...
                <div class="col-lg-4 text-center">
                    <div class="mt-5">
                        <div class="card text-center shadow mx-3">
                            <!-- UBAH -->
                            <a href="https://meet.google.com/ayx-scmx-fsq" target="_blank" class="text-decoration-none">
                                <img src="<?= base_url() ?>front/assets/img/ka.jpg" class="card-img-top">
                            </a>
                            <div class="card-body">
                                <h4 class="card-title">Sekolah Minggu</h4>
                                <!-- UBAH -->
                                <p class="card-text">"Masa Depan Penuh Harapan"<br>Minggu, 24 Oktober 2021 - 09.00 WIB <br>Kak Brina & pak Wahyu</p>
                            </div>
                            <div class="card-body">
                                <!-- UBAH -->
                                <a href="https://meet.google.com/ayx-scmx-fsq" target="_blank" class="btn btn-primary mb-2 px-5" style="border-radius: 10rem; font-size: 11pt">Link</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="mt-5">
                        <div class="card text-center shadow mx-3">
                            ...
                            <div class="card-body">
                                ...
                                <!-- UBAH -->
                                <p class="card-text">"Quality Time"<br>Minggu, 24 Oktober 2021 - 17.00 WIB <br>Sdri. Agnes Kristanti N.</p>
                            </div>
                            <div class="card-body">
                                <!-- UBAH -->
                ...
                <div class="col-lg-4 text-center ">
                    <div class="mt-5">
                        <div class="card text-center shadow mx-3">
                            <!-- UBAH -->
                            <a href="https://meet.google.com/ivm-tqxs-kaa" target="_blank" class="text-decoration-none">
                                <img src="<?= base_url() ?>front/assets/img/sarasehan.jpg" class="card-img-top">
                            </a>
                            <div class="card-body">
                                <h4 class="card-title">Sarasehan Bulan Keluarga</h4>
                                <!-- UBAH -->
                                <p class="card-text">"Ketahanan Keluarga di Tengah Krisis Kehidupan"<br>Jumat, 29 Oktober 2021 - 18.00 WIB <br>Ibu Lydia Indriarti, S.Si.</p>
                            </div>
                            <div class="card-body">
                                <!-- UBAH -->
                                <a href="https://meet.google.com/ivm-tqxs-kaa" target="_blank" class="btn btn-primary mb-2 px-5" style="border-radius: 10rem; font-size: 11pt">Link</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row gx-4 gx-lg-5 justify-content-center">
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <!-- UBAH -->
                        <a class="text-decoration-none" href="<?= base_url() ?>front/assets/docs/warta.docx" download="Warta Jemaat 24 Oktober 2021">
                ...
                <div class="col-lg-4 col-md-6 text-center">
                    <div class="mt-5">
                        ...
                        <!-- UBAH -->
                        <a class="text-decoration-none" href="<?= base_url() ?>front/assets/docs/liturgi.docx" download="Liturgi Ibadah 24 Oktober 2021"> <span class="h6 text-light"><i class="bi bi-download fs-4 mx-1"></i>
                                Download
                            </span>
                        </a>
                    </div>
