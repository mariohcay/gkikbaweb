                ...
                <div class="col-lg-4">
                    <div class="mt-5">
                        <div class="card text-center shadow mx-3">
                            <!-- UBAH -->
                            <a href="https://youtu.be/vaclbx4CuP8" target="_blank" class="text-decoration-none">
                                <img src="<?= base_url() ?>front/assets/img/umum.jpg" class="card-img-top">
                            </a>
                            <div class="card-body">
                                <h4 class="card-title">Ibadah Umum</h4>
                                <!-- UBAH -->
                                <p class="card-text">"Tuah Kata Kasih"<br>Minggu, 15 Mei 2022 - 07.00 WIB<br>Pdt. Edi Wahono</p>
                            </div>
                            <div class="card-body">
                                <!-- UBAH -->
                                ...
                                <a href="https://youtu.be/vaclbx4CuP8" target="_blank" class="btn btn-primary mb-2 px-5 mx-1" style="border-radius: 10rem; font-size: 11pt">Online</a>
                            </div>
                        </div>
                    </div>
                </div>
