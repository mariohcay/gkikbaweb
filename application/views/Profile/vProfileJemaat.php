        ...
        <ul class="list-group">
          ...
          <li class="list-group-item">
            ...
            <select class="custom-select" name="vaksin">
              <option value="" class="d-block" <?php if ($jemaat['vaksin'] === "") {
                                                  echo "selected";
                                                }; ?> disabled>Pilih...</option>
              <option value="Belum vaksin" class="d-block" <?php if ($jemaat['vaksin'] === "Belum vaksin") {
                                                              echo "selected";
                                                            }; ?>>Belum vaksin</option>
              <option value="Sudah 1x" class="d-block" <?php if ($jemaat['vaksin'] === "Sudah 1x") {
                                                          echo "selected";
                                                        }; ?>>Sudah 1x</option>
